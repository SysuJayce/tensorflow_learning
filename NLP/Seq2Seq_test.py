...
class NMTModel(object):
    ...
    def inference(self, src_input):
        ...
        with tf.variable_scope('decoder/rnn/multi_rnn_cell'):
            ...
            # 构建初始的循环状态。循环状态包含循环神经网络的隐藏状态，保存生成
            # 句子的TensorArray，以及记录解码步数的一个整数step
            ...
            def loop_body(state, trg_ids, step):
                ...
                dec_outputs, nex_state = self.dec_cell.call(trg_emb, state)
                ...
                return nex_state, trg_ids, step + 1
